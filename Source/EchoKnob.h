...
class EchoKnob : public LookAndFeel_V4 // inherit from LookAndFeel_V4
{
public:
                                      ...
                                      Slider &     slider )
    {
        ...
        int offsetFactor = 2; /// the placement order of the files relative to the other files in the BinaryData
        int numFrames = 128;
...
private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EchoKnob);
};
